...
SGModalRes::SGModalRes()
{
    itemType = SGItemType::ItemTypeResistance;
    itemIdentifier = "SG.Resistance";

    modalValue.append("10.0");
    modalValueDescription.append(SGModalValueDescription(SGModalValueType::ModalValueTypeDouble, "电阻的阻值（欧姆）"));
}

void SGModalRes::drawItem(QWidget *paintWidget, SGCanvasViewInfo viewInfo)
{
