...
LGBaseModel::LGBaseModel()
{
    dataType = LGModelType::DataModelUnknown;
}

QStringList LGBaseModel::csvReader(QString filePath)
{
...
void LGBaseModel::setAnimationOptions(QChart* chart)
{
...
LG2DBarModel::LG2DBarModel()
{
    dataType = LGModelType::DataModelBar2D;
}

bool LG2DBarModel::importFromCSV(QString filePath)
{
...
QChart* LG2DBarModel::getChart()
{

    QChart* chart = new QChart();
    chart->setTitle(title);
   
    if(dataType == LGModelType::DataModelBar2D) {
    ...
    if(dataType == LGModelType::DataModelPie2D) {
...
LG2DPointModel::LG2DPointModel()
{
    dataType = LGModelType::DataModelLine2D;
}
    
bool LG2DPointModel::importFromCSV(QString filePath)
{
    QStringList lines = csvReader(filePath);
...
QChart* LG2DPointModel::getChart()
{
    QChart* chart = new QChart();
    chart->setTitle(title);
   
    if(dataType == LGModelType::DataModelLine2D) {
    ...
    if(dataType == LGModelType::DataModelArea2D) {
        for(LG2DPointSeries sdata : seriesData) {
...
LG3DBarModel::LG3DBarModel()
{
    
    dataType = LGModelType::DataModelBar3D;
}

bool LG3DBarModel::importFromCSV(QString filePath)
{
    QStringList lines = csvReader(filePath);
...
Q3DBars* LG3DBarModel::get3DBars()
{
